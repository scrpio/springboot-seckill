...
-- ----------------------------
INSERT INTO `sk_goods_seckill` VALUES ('1', '1', '0.01', '6', '2018-05-22 17:22:52', '2018-05-22 18:23:00', '2');
INSERT INTO `sk_goods_seckill` VALUES ('2', '2', '0.01', '7', '2018-04-29 22:56:10', '2018-05-01 22:56:15', '1');
...
-- Records of sk_order
-- ----------------------------
INSERT INTO `sk_order` VALUES ('1', '18217272828', '2', '0', '华为 Mate 10', '1', '4199.00', '1', '0', '2020-05-20 09:01:02', null);
INSERT INTO `sk_order` VALUES ('2', '18217272828', '1', '0', 'iphoneX', '1', '7788.00', '1', '0', '2020-05-20 09:20:22', null);

-- ----------------------------
-- Table structure for sk_order_seckill
-- ----------------------------
DROP TABLE IF EXISTS `sk_order_seckill`;
CREATE TABLE `sk_order_seckill` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) DEFAULT NULL,
...
-- ----------------------------
-- Records of sk_order_seckill
-- ----------------------------
INSERT INTO `sk_order_seckill` VALUES ('1', '18217272828', '1', '2');
INSERT INTO `sk_order_seckill` VALUES ('2', '18217272828', '2', '1');
